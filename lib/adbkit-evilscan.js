      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            handler = function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(device, port) {
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        device.client = trackClients[device.ip] = trackClients[device.ip] || _adb2.default.createClient(port);
                        return _context.abrupt('return', device.client.connect(device.ip, device.port).then(function () {
