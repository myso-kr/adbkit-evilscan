                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return _context.abrupt('return', device.client.connect(network.ip, network.port).then(function (device) {
                          tracker.emit('add', _lodash2.default.assign({ adb: adb }, network, device));
                        }).catch(function () {}));
